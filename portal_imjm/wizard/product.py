...
class ProductoSatAceptable(models.TransientModel):
    ...
    def _get_default_code(self):
        product_sat_obj = self.env['l10n_mx_edi.product.sat.code']
        ya_aceptados = product_sat_obj.search([('aceptable','=',True)])
        return ya_aceptados.ids

    name = fields.Char('Nombre')
    sat_code_aceptado_ids = fields.Many2many('l10n_mx_edi.product.sat.code', 'product_dynamic_fields_aceptado_rel', 'wiz_id', 'satcode_id', default=_get_default_code)
